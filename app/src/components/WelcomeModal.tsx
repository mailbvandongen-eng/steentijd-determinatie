...
const CHANGELOG = [
  { version: '2.2.86', date: '3 apr 2026', changes: ['Tijdens een lopende determinatie kun je nu extra detailfoto’s toevoegen, bijvoorbeeld voor microretouche, doorsnede, slagvlak of schachtdoorn', 'Deze detailfoto’s worden apart opgeslagen van de 4 hoofdopnames, zodat de basisopzet van de captureflow intact blijft', 'Detailfoto’s worden lokaal aan de sessie gekoppeld, op het resultaatscherm getoond en via sync als aparte thumbnails meegenomen'] },
  { version: '2.2.85', date: '3 apr 2026', changes: ['Tijdens een lopende determinatie kun je nu met "Kijk even mee" een adviserend AI-oordeel opvragen over het huidige pad', 'Die check gebruikt de foto, de huidige vraag en het al doorlopen beslispad, maar neemt de determinatie niet over', 'Daardoor kun je bij twijfel eerder bijsturen zonder te hoeven wachten op de eindbeoordeling'] },
  { version: '2.2.84', date: '3 apr 2026', changes: ['Het startscherm opent nu via een duidelijke determinatie-ingang met de routes Start, Stap in en Vrij determineren', 'Stap in vervangt de eerdere snelle-instaptaal en maakt duidelijker dat AI alleen advies geeft en de gebruiker altijd kan overrulen', 'Vrij determineren staat nu als volwaardige leer- en oefenroute naast de gewone startflow'] },
  { version: '2.2.83', date: '3 apr 2026', changes: ['Snelle instap is niet langer verborgen voor beginners zolang er een stabiele verkorte instap voor die familie bestaat', 'Hints en referentiebeelden blijven nu op alle niveaus beschikbaar, zodat gevorderd en expert ook echt leerniveaus blijven', 'De navigatortekst maakt nu duidelijk dat hints ondersteuning zijn en geen beginnersprivilege'] },
  { version: '2.2.82', date: '3 apr 2026', changes: ['Sessies slaan nu op vanuit welke snelle-instapfamilie je bent gestart en of je daarna de verkorte of volledige route gebruikte', 'Die herkomst is nu zichtbaar op het resultaatscherm en in de vondstgeschiedenis, zodat testfeedback beter te reconstrueren is', 'Ook sync neemt deze quick-start herkomst nu mee tussen apparaten'] },
  { version: '2.2.81', date: '3 apr 2026', changes: ['Per snelle-instapfamilie laat de reviewkaart nu ook voorbeelden zien van subtype-uitkomsten die je ongeveer in die familie kunt verwachten', 'Die subtype-preview gaat ook mee in de AI-plausibiliteitscheck, zodat de familiekeuze niet alleen op hoofdvorm maar ook op verwachte verdieping wordt beoordeeld', 'Daardoor krijgt snelle instap meer inhoudelijke context vóórdat je de boom in gaat'] },
  { version: '2.2.80', date: '3 apr 2026', changes: ['Een nieuwe quick-start matrix rekent nu per familie en niveau door hoeveel specifieke uitkomsten vanaf het gekozen instappunt bereikbaar zijn', 'De matrix staat nu op 33 routes en 0 families die inhoudelijk doodlopen zonder subtype-uitkomsten', 'Daardoor wordt snelle instap nu niet alleen op startvragen maar ook op inhoudelijke uitwaaiering regressietestbaar'] },
