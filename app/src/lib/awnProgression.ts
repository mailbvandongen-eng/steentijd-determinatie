...
export const AWN_TEST_PHASES: AwnTestPhase[] = [
  ...
  },
  {
    ...
    status: 'planned',
    summary: 'Vuistbijlen, kleine bifaciale stukken en overige kern-werktuigen.',
  },
  {
    id: 'phase-4-geslepen-werktuigen',
    title: 'Fase 4: Geslepen Werktuigen',
    status: 'planned',
    summary: 'Vuurstenen bijlen en overige geslepen werktuigen volgens AWN niveau 2C/3C.',
  },
  {
    id: 'phase-5-doorboorde-werktuigen',
    title: 'Fase 5: Doorboorde Werktuigen',
    status: 'planned',
    summary: 'Doorboorde werktuigen en hamerbijlen volgens AWN niveau 2D/3D.',
  },
  {
