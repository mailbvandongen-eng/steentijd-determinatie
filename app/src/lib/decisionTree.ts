...
function getExpertContextualJump(
  ...
  if ((target === 'de-kern-of-brok-is-voorzien-van-een-werkkant-punt' || target === 'kern-of-brok-met-werkkant-punt') && questionId === '105') {
    return '113';
  }
...
const DISPLAY_NAMES: Record<string, string> = {
  ...
  splinter: 'Splinter',
  'één-of-meer-afslagnegatieven': 'Artefact met afslagnegatieven',
  'een-brokvorstsplijting--getest': 'Geteste brok of vorstsplijting',
  'brokvorstsplijting--getest': 'Geteste brok of vorstsplijting',
  ...
  'met-parallelle-afslagnegatieven-kern--kling--montbani': 'Montbani-klingkern',
  'een-kern--kielvormig': 'Kielvormige kern',
  'kern--kielvormig': 'Kielvormige kern',
  ...
  'artefact-van-vuursteen--kwartsiet-of-lydiet': 'Artefact van vuursteen, kwartsiet of lydiet',
  'géén-gat-of-een-natuurlijk-gat': 'Geen doorboord artefact',
  'het-artefact-is-een-knol--brok-of-vorstsplijting': 'Knol, brok of vorstsplijting',
  'het-is-een-artefact': 'Artefact',
  artefact: 'Artefact',
  ...
  'doorboord--artefact': 'Doorboord artefact',
  afslag: 'Afslag',
  'afslag-of-kling': 'Afslag of kling',
  'afslag--bijl': 'Bijlafslag',
  kling: 'Kling',
  'kling--werktuig': 'Klingwerktuig',
  'afslag--kombewa': 'Kombewa-afslag',
  'afslag--kombewa--gemodificeerd': 'Gemodificeerde Kombewa-afslag',
  'afslag--decorticatie--gemodificeerd': 'Gemodificeerde decorticatie-afslag',
  'bij-opm-vermelden-plaatselijk-geretoucheerd': 'Plaatselijk geretoucheerd artefact',
  'afslag--levallois': 'Levallois-afslag',
  'afslag--levallois--gemodificeerd': 'Gemodificeerde Levallois-afslag',
  'spits--levallois': 'Levallois-spits',
  'spits--levallois--gemodificeerd': 'Gemodificeerde Levallois-spits',
  'spits--tayac': 'Tayac-spits',
  'spits--quinson': 'Quinson-spits',
  'spits--soyons': 'Soyons-spits',
  'spits--emireh': 'Emireh-spits',
  'spits--mousterien': 'Mousterien-spits',
  'spits--pseudo--levallois': 'Pseudo-Levallois-spits',
  'spits--pseudo--levallois--gemodificeerd': 'Gemodificeerde pseudo-Levallois-spits',
  'afslag--kernpreparatie': 'Kernpreparatie-afslag',
  'afslag--kernpreparatie--gemodificeerd': 'Gemodificeerde kernpreparatie-afslag',
  'afslag--kernvernieuwing': 'Kernvernieuwings-afslag',
  'afslag--kernvernieuwing--gemodificeerd': 'Gemodificeerde kernvernieuwings-afslag',
  'afslag--vuistbijl': 'Vuistbijlafslag',
  'afslag--vuistbijl--gemodificeerd': 'Gemodificeerde vuistbijlafslag',
  'afslag--geslepen--bijl': 'Bijlafslag met slijpsporen',
  'afslag--geslepen--bijl-gemodificeerd': 'Gemodificeerde bijlafslag met slijpsporen',
  'afslag--gemodificeerd': 'Gemodificeerde afslag',
  'afslagkling--werktuig': 'Afslag- of klingwerktuig',
  ...
  'kling--kernpreparatie--gemodificeerd': 'Gemodificeerde kernpreparatie-kling',
  'kling--montbanistijl': 'Kling in Montbani-stijl',
  'kling--montbanistijl--gemodificeerd': 'Gemodificeerde Montbani-kling',
  'kling--coincystijl--gemodificeerd': 'Gemodificeerde Coincy-kling',
  'kling--gekerfd': 'Gekerfde kling',
  'kling-gemodificeerd': 'Gemodificeerde kling',
  stekerafslag: 'Stekerafslag',
  'stekerafslag--gemodificeerd': 'Gemodificeerde stekerafslag',
  lamelle: 'Lamelle',
  'lamelle--dufour': 'Lamelle Dufour',
  'lamelle--font-yves': 'Lamelle Font-Yves',
  'lamelle--gemodificeerd': 'Gemodificeerde lamelle',
  ...
  'steker--transversaal': 'Transversale steker',
  'steker--papegaaienbek': 'Papegaaienbeksteker',
  'steker--noailles': 'Noailles-steker',
  ...
  'schrabber--groot-rondova-al': 'Grote ronde/ovale schrabber',
  'schrabber--micro-of-knoop': 'Micro- of knoopschrabber',
  'schrabber--micro-og-schrabber--knoop': 'Micro- of knoopschrabber',
  ...
  'schrabbe-r-bec-vormig': 'Bec-vormige schrabber',
  ...
  'schaaf--demi--quina--dubbel': 'Dubbele demi-Quina-schaaf',
  'schaaf--enkelvoudig': 'Enkelvoudige schaaf',
  'schaaf--transversaal': 'Transversale schaaf',
  'schaaf--raclette': 'Raclette-schaaf',
  ...
  'convergerende-dubbelschaaf-o-g-schaaf--spits': 'Convergerende dubbelschaaf / schaafspits',
  'grattoir--caréné-rabot-of-schrabber--kern': 'Carene-grattoir / rabot / schrabberkern',
  'een-schrabber--steker': 'Schrabber-steker',
  'een-schrabber--steker--krombek': 'Schrabber-steker met krombek',
  ...
  'spits--ongelijkbenige--driehoek--met-': 'Ongelijkbenige driehoekige spits met oppervlakteretouche',
  ...
  'grof-bekapt-of-tranchetsnede': 'Grof bekapt artefact of tranchetsnede',
  'afslag--grof-bekapt-of-kling--grof-bekapt': 'Grof bekapte afslag of kling',
  ...
  'spits--havelter-steelspits': 'Havelter-steelspits',
  'spits--steel': 'Steelspits',
  'de-spits-heeft-ste-il-geretoucheerde-zijden-en-evt-basis': 'Spits met steil geretoucheerde zijden en eventueel basis',
  ...
  'spits--transversaal-transversaal-dus': 'Transversaalspits',
  'spits--trapezium--breed': 'Breed trapezium',
  'spits--trapezium--breed-sub-typen-zijn-': 'Breed trapezium',
  'spits--trapezium--smal': 'Smal trapezium',
  'spits--trapezium--smal-sub-typen-zijn': 'Smal trapezium',
  'spits--vierhoekig': 'Vierhoekige spits',
  'spits--vierhoek--asymmetrisch': 'Asymmetrische vierhoekige spits',
  ...
  'spits--geometrisch': 'Geometrische spits',
  'spits--feuille--de-gui': 'Feuille-de-gui-spits',
  ...
  'aan-twee': 'Aan twee zijden bewerkt artefact',
  'aan-beide-oppervlakken': 'Aan beide oppervlakken bewerkt artefact',
  'spits-eenzijdig-en-basis': 'Spits met geretoucheerde zijde en basis',
  'één-zijde--basis-niet': 'Spits met één geheel geretoucheerde zijde en ongeretoucheerde basis',
  'één-zijde-en-de-basis': 'Spits met één geheel geretoucheerde zijde en geretoucheerde basis',
  'geheel-geretoucheerde-zijde': 'Spits met geheel geretoucheerde zijde',
  gelijkbenig: 'Gelijkbenig artefact',
  ...
  'fijner-bewerkt': 'Fijner bewerkt artefact',
  'zorgvuldiger-bewerkt': 'Zorgvuldiger bewerkt artefact',
  'heel-klein--6-cm-of-heel-dun': 'Heel klein of heel dun artefact',
  'relatief-klein': 'Relatief klein artefact',
  chopper: 'Chopper',
  ...
  bijl: 'Bijl',
  'een-kern': 'Kern',
  'één-slagvlak': 'Kern met één slagvlak',
  'meer-dan-één-slagvlak': 'Kern met meer dan één slagvlak',
  'een-klein-of-onherkenbaar-slagvlak': 'Klein of onherkenbaar slagvlak',
  'klein-of-onherkenbaar-slagvlak': 'Klein of onherkenbaar slagvlak',
  'groot-of-herkenbaar-slagvlak': 'Groot of herkenbaar slagvlak',
  'geen-cortex': 'Artefact zonder cortex',
  'lange-afslagnegatieven': 'Artefact met lange afslagnegatieven',
  'mogelijk-gemodificeerd': 'Mogelijk gemodificeerd artefact',
  'kern-gemodificeerd-of-brok-gemodificeerd': 'Gemodificeerde kern of brok',
  'kern-of-brok-met-werkkant-punt': 'Kern of brok met werkkant of punt',
  '1-of-2-het-is-een-brok-of-vorstsplijting': 'Brok of vorstsplijting met een of twee afslagnegatieven',
  'bijl-kern': 'Kernbijl',
  ...
  'asymmetrische-driehoekige-dwarsdoorsnede': 'Asymmetrische driehoekige dwarsdoorsnede',
  ...
  'dolk--scandinavisch': 'Scandinavische dolk',
  'dolk--grand--pressigny': 'Grand-Pressigny-dolk',
  'geslepen--bijl': 'Geslepen bijl',
  'geslepen--vuurstenen--artefact': 'Geslepen vuurstenen artefact',
  'geslepen--stenen--artefact': 'Geslepen stenen artefact',
  ...
  'bijl-smaltoppig--met-ovale--dwarsdoorsnede--en-': 'Smaltoppige vuurstenen bijl met ovale dwarsdoorsnede en geslepen zijden',
  ...
  'bijl-smaltoppig--met-ovale--tot-vlak-ovale--': 'Smaltoppige vuurstenen bijl met ovale tot vlakovale dwarsdoorsnede',
  'bijl-smaltoppig--met-afgerond--rombische--': 'Smaltoppige vuurstenen bijl met afgerond rombische dwarsdoorsnede',
  'bijl-breedtoppig--met-rondovale--dwarsdoorsnede': 'Breedtoppige vuurstenen bijl met rondovale dwarsdoorsnede',
  'bijl-breedtoppig--met-rond--ovale--dwarsdoorsnede': 'Breedtoppige vuurstenen bijl met rondovale dwarsdoorsnede',
  'bijl-breedtoppig--met-ovale--dwarsdoorsnede--en-geslepen--zijden': 'Breedtoppige vuurstenen bijl met geslepen zijden',
  'bijl-breedtoppig--met-ovale--dwarsdoorsnede': 'Breedtoppige vuurstenen bijl met ovale dwarsdoorsnede',
  'bijl-breed-toppig--met-ovale--dwarsdoorsnede--met-': 'Breedtoppige vuurstenen bijl met ovale dwarsdoorsnede en geslepen zijden',
  'bijl-buren': 'Buren-bijl',
  'bijl-dunbladig--met-ovale--dwarsdoorsnede': 'Dunbladige vuurstenen bijl met ovale dwarsdoorsnede',
  'bijl-dunbladig--met-ovale--dwarsdoorsnede-og': 'Dunbladige vuurstenen bijl met ovale dwarsdoorsnede',
  ...
  'bijl-met-rechthoekige--dwarsdoorsnede--en-brede--': 'Vuurstenen bijl met rechthoekige dwarsdoorsnede en brede snede',
  ...
  'bijl-met-ronde--dwarsdoorsnede--en-stompe--top-': 'Stenen bijl met ronde dwarsdoorsnede en stompe top',
  'bijl-met-ronde--dwarsdoorsnede--en-stompe--top-met-': 'Stenen bijl met ronde dwarsdoorsnede en stompe top',
  'bijl-met-ronde--dwarsdoorsnede--en-dunne--smalle--': 'Stenen bijl met ronde dwarsdoorsnede en dunne smalle top',
  'bijl-met-ovale--doorsnede--en-smalle--top-doorsnede--': 'Stenen bijl met ovale dwarsdoorsnede en smalle top',
  ...
  'bijl-met-rechthoekige--dwarsdoorsnede--en-dunne--': 'Vuurstenen bijl met rechthoekige dwarsdoorsnede en dunne top',
  'vuursteenbijl-met-rechthoekige-dwarsdoorsnede': 'Vuursteenbijl met rechthoekige dwarsdoorsnede',
  'bijl-met-rechthoekige--doorsnede': 'Vuurstenen bijl met rechthoekige dwarsdoorsnede',
  'bijl-met-rechthoekige--doorsnede--lang': 'Langwerpige vuurstenen bijl met rechthoekige dwarsdoorsnede',
  'bijl-met-rechthoekige--doorsnede--lang-klokvormig': 'Langwerpige klokvormige vuurstenen bijl met rechthoekige dwarsdoorsnede',
  'bijl-met-rechthoekige--doorsnede--lang-': 'Langwerpige vuurstenen bijl met rechthoekige dwarsdoorsnede',
  'bijl-met-rechthoekige--doorsnede--lang-rechthoekig': 'Langwerpige rechthoekige vuurstenen bijl',
  'bijl-met-rechthoekige--doorsnede--kort': 'Korte vuurstenen bijl met rechthoekige dwarsdoorsnede',
  'bijl-met-rechthoekige--doorsnede--kort-klokvormig': 'Korte klokvormige vuurstenen bijl met rechthoekige dwarsdoorsnede',
  'bijl-met-rechthoekige--doorsnede--kort-': 'Korte vuurstenen bijl met rechthoekige dwarsdoorsnede',
  'bijl-met-rechthoekige--doorsnede--kort-rechthoekig': 'Korte rechthoekige vuurstenen bijl',
  ...
  'inzetstuk--dorsslede': 'Inzetstuk van dorsslede',
  'de-vuurkets-is-aan-één-zijde-is-afgerond-of-de-vuurkets': 'Afgeronde vuurkets',
  'zie-vorige-determinatie-': 'Zie vorige determinatie',
  'zie-ook': 'Zie ook',
  'einde-te-vermelden-bij-opmerkingen-': 'Aan het einde vermelden bij opmerkingen',
  'ik-twijfel-het-is-een-incertofact-determineren-als': 'Twijfelgeval / incertofact',
  'vermeld-secundaire--retouche-of-gebruiks--retouche': 'Vermeld secundaire of gebruiksretouche',
  'vermeld-vermoedelijk--gekerfd': 'Vermoedelijk gekerfd artefact',
  'vermeld-vermoedelijk--getand': 'Vermoedelijk getand artefact',
  'vermeld-vermoedelijk--recente--beschadiging': 'Vermoedelijk recente beschadiging',
  'vermeld-vermoedelijke--schachtingssporen': 'Vermoedelijke schachtingssporen',
  ...
  'vermeld-vermoedelijk--afgeknot': 'Vermoedelijk afgeknot artefact',
  ...
  'doorboord-werktuig': 'Doorboord werktuig',
  'onvolledig-doorboord-dellensteen': 'Onvolledig doorboorde dellensteen',
  polsbeschermer: 'Polsbeschermer',
  ...
  'bijl-dissel-og-schoenleestbijl': 'Schoenleestbijl of dissel',
  'bijl-disselkling': 'Disselkling',
  'bijl-afslagbijl': 'Afslagbijl',
  'bijl-dissel--hoog': 'Hoge dissel',
  'bijl-dissel--vlak': 'Vlakke dissel',
  ...
  'afgerond-verdikking-en-nagenoeg-ronde-doorsnede': 'Hamerbijl met afgeronde verdikking en nagenoeg ronde doorsnede',
  'asymmetrisch-en-ronde-dwarsdoorsnede': 'Asymmetrische hamerbijl met ronde dwarsdoorsnede',
  'een-ronde-dwarsdoorsnede-van-de-nek': 'Hamerbijl met ronde dwarsdoorsnede van de nek',
  'met-scherpe-verdikking': 'Hamerbijl met scherpe verdikking',
  ...
  'met-lichte-verdikking-bijl-hamer--type-epe': 'Hamerbijl type Epe met lichte verdikking',
  'type-zuidvelde-en-emmen': 'Hamerbijl type Zuidvelde of Emmen',
