...
const SCENARIOS = [
  ...
  { id: 'geslepen_bijl_brede_snede', label: 'Geslepen: vuurstenen bijl met brede snede', target: 'bijl-met-rechthoekige--dwarsdoorsnede--en-brede--snede', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'doorboorde--', 'beitel--', 'bijl-hamer', 'bijl-dubbel'] },
  { id: 'geslepen_bijl_dunne_scherpe_top', label: 'Geslepen: vuurstenen bijl met dunne scherpe top', target: 'bijl-met-rechthoekige--dwarsdoorsnede--en-dunne--scherpe--top', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'doorboorde--', 'beitel--', 'bijl-hamer', 'bijl-dubbel'] },
  { id: 'geslepen_bijl_dunne_vlakke_top', label: 'Geslepen: vuurstenen bijl met dunne vlakke top', target: 'bijl-met-rechthoekige--dwarsdoorsnede--en-dunne--vlakke--top', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'doorboorde--', 'beitel--', 'bijl-hamer', 'bijl-dubbel'] },
  { id: 'geslepen_bijl_dunne_onregelmatige_top', label: 'Geslepen: vuurstenen bijl met dunne onregelmatige top', target: 'bijl-met-rechthoekige--dwarsdoorsnede--en-dunne--onregelmatige--top', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'doorboorde--', 'beitel--', 'bijl-hamer', 'bijl-dubbel'] },
  { id: 'geslepen_bijl_dikbladig_sterk_gebogen', label: 'Geslepen: dikbladige vuurstenen bijl sterk gebogen', target: 'bijl-met-rechthoekige--dwarsdoorsnede--dikbladig--sterk-gebogen', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'doorboorde--', 'beitel--', 'bijl-hamer', 'bijl-dubbel'] },
  { id: 'geslepen_bijl_dikbladig_weinig_gekromd', label: 'Geslepen: dikbladige vuurstenen bijl weinig gekromd', target: 'bijl-met-rechthoekige--dwarsdoorsnede--dikbladig--weinig-gekromd', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'doorboorde--', 'beitel--', 'bijl-hamer', 'bijl-dubbel'] },
  { id: 'geslepen_bijl_dikbladig_parallel', label: 'Geslepen: dikbladige vuurstenen bijl parallel', target: 'bijl-met-rechthoekige--dwarsdoorsnede--dikbladig--parallel', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'doorboorde--', 'beitel--', 'bijl-hamer', 'bijl-dubbel'] },
  { id: 'geslepen_bijl_dunbladig_sterk_gekromd', label: 'Geslepen: dunbladige vuurstenen bijl sterk gekromd', target: 'bijl-met-rechthoekige--dwarsdoorsnede--dunbladig--sterk-gekromd', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'doorboorde--', 'beitel--', 'bijl-hamer', 'bijl-dubbel'] },
  { id: 'geslepen_bijl_dunbladig_parallel', label: 'Geslepen: dunbladige vuurstenen bijl parallel', target: 'bijl-met-rechthoekige--dwarsdoorsnede--dunbladig--parallel', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'doorboorde--', 'beitel--', 'bijl-hamer', 'bijl-dubbel'] },
  ...
  { id: 'geslepen_dissel_gebogen', label: 'Geslepen: dissel met gebogen onder- en bovenzijde', target: 'bijl-dissel--met-gebogen--onder--en-bovenzijde', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'doorboorde--', 'beitel--', 'bijl-vlakbijl', 'bijl-hamer', 'bijl-dubbel'] },
  { id: 'geslepen_dissel_parallel', label: 'Geslepen: dissel met parallelle onder- en bovenzijde', target: 'bijl-dissel--met-parallelle--onder--en-bovenzijde', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'doorboorde--', 'beitel--', 'bijl-vlakbijl', 'bijl-hamer', 'bijl-dubbel'] },
  ...
  { id: 'doorboord_hamerbijl_type_b', label: 'Doorboord: hamerbijl type B', target: 'bijl-hamer--type-b', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'bijl-vlakbijl', 'beitel', 'bijl-dubbel', 'doorboorde--rolsteen', 'doorboorde--schijfvormige--steen', 'doorboorde--breedwig'] },
  { id: 'doorboord_hamerbijl_type_i', label: 'Doorboord: hamerbijl type I', target: 'bijl-hamer--type-i', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'bijl-vlakbijl', 'beitel', 'bijl-dubbel', 'doorboorde--rolsteen', 'doorboorde--schijfvormige--steen', 'doorboorde--breedwig'] },
  { id: 'doorboord_hamerbijl_type_r', label: 'Doorboord: hamerbijl type R', target: 'bijl-hamer--type-r', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'bijl-vlakbijl', 'beitel', 'bijl-dubbel', 'doorboorde--rolsteen', 'doorboorde--schijfvormige--steen', 'doorboorde--breedwig'] },
  { id: 'doorboord_hamerbijl_type_c', label: 'Doorboord: hamerbijl type C', target: 'bijl-hamer--type-c', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'bijl-vlakbijl', 'beitel', 'bijl-dubbel', 'doorboorde--rolsteen', 'doorboorde--schijfvormige--steen', 'doorboorde--breedwig'] },
  { id: 'doorboord_hamerbijl_type_d', label: 'Doorboord: hamerbijl type D', target: 'bijl-hamer--type-d', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'bijl-vlakbijl', 'beitel', 'bijl-dubbel', 'doorboorde--rolsteen', 'doorboorde--schijfvormige--steen', 'doorboorde--breedwig'] },
  { id: 'doorboord_hamerbijl_type_f', label: 'Doorboord: hamerbijl type F', target: 'bijl-hamer--type-f', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'bijl-vlakbijl', 'beitel', 'bijl-dubbel', 'doorboorde--rolsteen', 'doorboorde--schijfvormige--steen', 'doorboorde--breedwig'] },
  { id: 'doorboord_hamerbijl_muntendam', label: 'Doorboord: hamerbijl type Muntendam', target: 'bijl-hamer--type-muntendam', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'bijl-vlakbijl', 'beitel', 'bijl-dubbel', 'doorboorde--rolsteen', 'doorboorde--schijfvormige--steen', 'doorboorde--breedwig'] },
  { id: 'doorboord_hamerbijl_zuidvelde', label: 'Doorboord: hamerbijl type Zuidvelde', target: 'met-rand-bijl-hamer--type-zuidvelde', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'bijl-vlakbijl', 'beitel', 'bijl-dubbel', 'doorboorde--rolsteen', 'doorboorde--schijfvormige--steen', 'doorboorde--breedwig'] },
  { id: 'doorboord_hamerbijl_emmen', label: 'Doorboord: hamerbijl type Emmen', target: 'zonder-rand-bijl-hamer--type-emmen', forbiddenPrefixes: ['kern--', 'schrabber', 'steker', 'spits--', 'rugmes', 'lamelle', 'bijl-vlakbijl', 'beitel', 'bijl-dubbel', 'doorboorde--rolsteen', 'doorboorde--schijfvormige--steen', 'doorboorde--breedwig'] },
];
